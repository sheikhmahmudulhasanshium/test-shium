...
const Bar: FunctionComponent<{ data: ISkill }> = ({ data: { Icon, level, name } }) => {
    ...
    // We explicitly type this as 'Variants' to fix the TypeScript error
    ...
    <div className='my-2 text-white bg-gray-600 rounded-full dark:bg-orange-300'>
      <motion.div 
        className="flex items-center px-4 py-1 rounded-full bg-gradient-to-r from-shiumcustom to-green-300"  
