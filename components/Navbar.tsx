...
const NavItem: FunctionComponent<{
  ...
  return (
    activeItem !== name ? (
      <Link href={route}>
        <span onClick={() => setActiveItem(name)} className="cursor-pointer hover:text-shiumcustom dark:text-white dark:hover:text-shiumcustom">
          {name}
        </span>
      </Link>
    ) : null
...
const Navbar = () => {
  ...
  }, [pathname]) // Added pathname here to fix the warning
