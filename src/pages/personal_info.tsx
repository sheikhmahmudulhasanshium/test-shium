...
const personal_info = () => {
  return (
    ...
    <div className='flex flex-col flex-grow px-6 py-4 pt-2 my-6 overflow-x-scroll font-medium tracking-wider dark:bg-slate-500 dark:text-white font-kaushan '>
        ...
        <div>
                <b>Awards:</b>
                <p>Dean&#39;s List (four consecutive semesters) for excellent academic performance.</p>
        </div>
        <div>
            <b>Experience:</b>
            <p>Worked as a Software Engineer (Intern) for 3 months.</p>
        </div>
        </div>
    </div>
    </motion.div>
